...
public class Exercises {
    ...
    */
    public static void exercise1(String message){
        ...
        Collection<Person> result = storage.findMany(person -> person.getFirstName().equals("Erik"));
    ...
    public static void exercise3(String message){
        System.out.println(message);
        //Write your code here
        final LocalDate date = LocalDate.parse("2000-01-01");
        storage.findMany(person -> person.getBirthDate().isAfter(date) || person.getBirthDate().equals(date))
                        .forEach(System.out::println);
